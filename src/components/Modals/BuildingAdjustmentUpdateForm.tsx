...
interface BuildingAdjustmentUpdateFormProps {
    formData: {
    ...
    handleFormChange: (field: keyof BuildingAdjustmentUpdateFormProps['formData'], value: string) => void;
            ...
            <IonRow>
                <IonCol size="12" className="custom-col">
                    ...
                    <IonText color="medium" style={{ padding: '0 16px', fontSize: '0.8rem' }}>
                        This adjustment is linked to the selected building.
                    </IonText>
                </IonCol>
            </IonRow>

            {isEditing && adjustmentId && (
                <IonRow>
                    <IonCol size="12" className="custom-col">
                        <IonItem className="custom-input">
                            <IonLabel position="stacked">Adjustment ID</IonLabel>
                            <IonInput value={adjustmentId} readonly disabled />
                        </IonItem>
                        <IonText color="medium" style={{ padding: '0 16px', fontSize: '0.8rem' }}>
...
export default BuildingAdjustmentUpdateForm;