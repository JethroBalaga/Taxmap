...
interface EquipmentFormSectionProps {
  title: string;
  children: React.ReactNode;
  className?: string;
}

const EquipmentFormSection: React.FC<EquipmentFormSectionProps> & {
...
EquipmentFormSection.Input = InputField;
EquipmentFormSection.Select = SelectField;
EquipmentFormSection.DateTime = DateTimeField;
EquipmentFormSection.Grid = Grid;
